...
const urls = {
    ...
    URL_GET_PROJECT: '/api/projects/v1/projects/key:${projectKey}',
    URL_GET_RUN_SUMMARY: '/api/reporting/v1/test-runs/${testRunId}/summary?projectId=${projectId}',
};
...
const getTestRunStart = (suite, reporterConfig) => {
    ...
    var configResolver = new ConfigResolver(reporterConfig)
