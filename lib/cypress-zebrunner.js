    ...
    this.runner
      ...
      .on(EVENT_SUITE_END, (suite) => {
        this.worker.send({
          ...
          //теперь воркер процессу посылается сообщение с одним дополнительным полем, которое содержит всю нужную информацию для нарезки видео
          //функция из файла object-transformer.js
          suiteTestsDurations: parseSuiteTestsDurations(suite)
        });
      })
